package com.lsh.databinghelper.bindingadapter.recyclerview;
...
public class ViewBindingAdapter {
    ...
    public static void onRefreshCommand(RecyclerView recyclerView, final ReplyCommand onRefreshCommand) {
